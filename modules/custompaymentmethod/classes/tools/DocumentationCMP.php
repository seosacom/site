...
class DocumentationCMP
{
    public static function assignDocumentation()
    {
        ...
        ToolsModuleCMP::addCSS('documentation.css');
        $documentation_folder = _PS_MODULE_DIR_.ToolsModuleCMP::getModNameForPath(
            __FILE__
        ).'/views/templates/admin/documentation';
        $documentation_pages = ToolsModuleCMP::globRecursive($documentation_folder.'/**.tpl');
