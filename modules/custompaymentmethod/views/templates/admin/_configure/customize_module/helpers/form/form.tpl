			...
			{foreach $fieldset.form as $key => $field}
				...
				{elseif $key == 'input'}
					<div class="form-wrapper">
						...
						<div class="clearfix">
							<div class="float-left margin-right-lg form-group">
                                {foreach $field as $input}
                                    {if $input.name == 'PS_CPM_DEFAULT_METHOD'}

                                        {block name="input_row"}
											<div class="{if isset($input.form_group_class)} {$input.form_group_class}{/if}{if $input.type == 'hidden'} hide{/if}"{if $input.name == 'id_state'} id="contains_states"{if !$contains_states} style="display:none;"{/if}{/if}{if $input.name == 'dni'} id="dni_required"{if !$dni_required} style="display:none;"{/if}{/if}{if isset($tabs) && isset($input.tab)} data-tab-id="{$input.tab}"{/if}>
                                                {if $input.type == 'hidden'}
													<input type="hidden" name="{$input.name}" id="{$input.name}" value="{$fields_value[$input.name]|escape:'html':'UTF-8'}" />
                                                {else}
                                                    {block name="label"}
                                                        {if isset($input.label)}
															<label class="float-left margin-right control-label {if isset($input.required) && $input.required && $input.type != 'radio'} required{/if}">
                                                                {if isset($input.hint)}
																	...
																	<div class="form-group">
                                                                        ...
                                                                        {/if}
																			...
																			<input type="text"
																				   ...
																				   class="fixed-width-sm {if isset($input.class)}{$input.class}{/if}{if $input.type == 'tags'} tagify{/if}"
							...
							<div class="float-left">
								<div class="float-left margin-right-lg form-group">
                                    {foreach $field as $input}
                                        {if $input.name == 'PS_CPM_ICON_WIDTH'}
                                            {block name="input_row"}
												<div class="{if isset($input.form_group_class)} {$input.form_group_class}{/if}{if $input.type == 'hidden'} hide{/if}"{if $input.name == 'id_state'} id="contains_states"{if !$contains_states} style="display:none;"{/if}{/if}{if $input.name == 'dni'} id="dni_required"{if !$dni_required} style="display:none;"{/if}{/if}{if isset($tabs) && isset($input.tab)} data-tab-id="{$input.tab}"{/if}>
                                                    {if $input.type == 'hidden'}
														<input type="hidden" name="{$input.name}" id="{$input.name}" value="{$fields_value[$input.name]|escape:'html':'UTF-8'}" />
								...
								<div class="float-left margin-right-lg form-group">
                                    {foreach $field as $input}
                                        {if $input.name == 'PS_CPM_ICON_HEIGHT'}
                                            {block name="input_row"}
												<div class="{if isset($input.form_group_class)} {$input.form_group_class}{/if}{if $input.type == 'hidden'} hide{/if}"{if $input.name == 'id_state'} id="contains_states"{if !$contains_states} style="display:none;"{/if}{/if}{if $input.name == 'dni'} id="dni_required"{if !$dni_required} style="display:none;"{/if}{/if}{if isset($tabs) && isset($input.tab)} data-tab-id="{$input.tab}"{/if}>
                                                    {if $input.type == 'hidden'}
														<input type="hidden" name="{$input.name}" id="{$input.name}" value="{$fields_value[$input.name]|escape:'html':'UTF-8'}" />
...
{if $firstCall}
	<script type="text/javascript">
		...
		var languages = new [];
        var vat_number = {if !empty($vat_number)}1{else}0{/if};
