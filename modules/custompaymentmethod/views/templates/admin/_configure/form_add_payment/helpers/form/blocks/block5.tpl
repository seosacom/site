...
<div class="form-wrapper">
                ...
                {if $input.name == 'type_commission'}
                    ...
                    {else}
                        <select name="{$input.name|escape:'html':'UTF-8'}"
                                class="{if isset($input.class)}{$input.class|escape:'html':'UTF-8'}{/if} fixed-width-md"
    ...
    <div class="form-group">
        {foreach $field as $input}
            {block name="label"}
                {if $input.name == 'apply_commission'}
                    {if isset($input.label)}
                        <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                            {$input.label}
                        </label>
        ...
        {foreach $field as $input}
            {block name="label"}
                {if $input.name == 'commission_use_tax_on_products'}
                    {if isset($input.label)}
                        <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                            {$input.label}
                        </label>
        ...
        {foreach $field as $input}
            {block name="input"}
                {if $input.type == 'radio' && $input.name == 'commission_use_tax_on_products'}
                    ...
                    {/foreach}
                {elseif $input.type == 'switch' && $input.name == 'commission_use_tax_on_products'}
    ...
    <div class="row">
        <div class="float-left js-switch margin-right-lg">

            {foreach $field as $input}
                {block name="label"}
                    {if $input.name == 'currency_commission'}
                        {if isset($input.label)}
                            <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                                {$input.label}
                            </label>
        ...
        <div class="float-left js-switch margin-right-lg">
            ...
            {foreach $field as $input}
                {block name="label"}
                    {if $input.name == 'commission_percent'}
                        {if isset($input.label)}
                            <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                                {$input.label}
                            </label>
                            ...
                            <div class="input-group{if isset($input.class)} {$input.class}{/if}">
                                ...
                                <div class="float-left margin-right-lg">
                                    <input type="text"
                                           ...
                                           value="{if isset($input.string_format) && $input.string_format}{$value_text|string_format:$input.string_format|escape:'html':'UTF-8'}{else}{$value_text|escape:'html':'UTF-8'}{/if}"
                                           class="fixed-width-sm text2 {if isset($input.class)}{$input.class}{/if}{if $input.type == 'tags'} tagify{/if}"
                                            {if isset($input.size)} size="{$input.size}"{/if}
                                            {if isset($input.maxchar) && $input.maxchar} data-maxchar="{$input.maxchar|intval}"{/if}
                                            {if isset($input.maxlength) && $input.maxlength} maxlength="{$input.maxlength|intval}"{/if}
                                            {if isset($input.readonly) && $input.readonly} readonly="readonly"{/if}
        ...
        <div class="float-left js-switch">

            {foreach $field as $input}
                {block name="label"}
                    {if $input.name == 'commission_amount'}
                        {if isset($input.label)}
                            <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                                {$input.label}
                            </label>
    ...
    <div class="form-group">
        ...
        {foreach $field as $input}
            {block name="label"}
                {if $input.name == 'commission_tax'}
                    {if isset($input.label)}
                        <label class="control-label float-left margin-right-lg irs-label" data-toggle="tooltip" data-html="true" title="">
                            {$input.label}
                        </label>
                    {/if}
                {/if}
    ...
    <div class="form-group">
        ...
        {foreach $field as $input}
            {block name="label"}
                {if $input.name == 'commission_switch'}
                    {if isset($input.label)}
                        <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                            {$input.label}
                        </label>
                            ...
                            {else}
                                {foreach $input.options.query AS $option}
                                    ...
                                    {elseif $option == "-"}
                                        <option value="">-</option>
                                    {else}
                                        <option value=" {if isset($option[$input.options.id])}{$option[$input.options.id]}{/if}"
                                                {if isset($input.multiple)}
                                                    {foreach $fields_value[$input.name] as $field_value}
                                                        {if isset($option[$input.options.id])}
                                                            {if $field_value == $option[$input.options.id]}
                                                                selected="selected"
                                                            {/if}
                                                        {/if}
