...
<div class="form-wrapper">
    ...
    <div class="form-group">
        ...
        {foreach $field as $input}
            {block name="label"}
                {if $input.name == 'discount_use_tax_on_products'}
                    {if isset($input.label)}
                        <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                            {$input.label}
                        </label>
        ...
        {foreach $field as $input}
            {block name="input"}
                {if $input.type == 'radio' && $input.name == 'discount_use_tax_on_products'}
                    ...
                    {/foreach}
                {elseif $input.type == 'switch' && $input.name == 'discount_use_tax_on_products'}
    ...
    <div class="row">
        ...
        <div class="float-left js-switch margin-right-lg">
            ...
            {foreach $field as $input}
                {block name="label"}
                    {if $input.name == 'currency_discount'}
                        {if isset($input.label)}
                            <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                                {$input.label}
                            </label>
        ...
        <div class="float-left js-switch margin-right-lg">
            {foreach $field as $input}
                {block name="label"}
                    {if $input.name == 'discount_percent'}
                        {if isset($input.label)}
                            <label class="control-label float-left margin-right" data-toggle="tooltip" data-html="true" title="">
                                {$input.label}
                            </label>
    ...
    <div class="form-group">
        ...
        {foreach $field as $input}
            {block name="label"}
                {if $input.name == 'discount_tax'}
                    {if isset($input.label)}
                        <label class="control-label float-left margin-right irs-label" data-toggle="tooltip" data-html="true" title="">
                            {$input.label}
                        </label>
                    {/if}
                {/if}
